...
export default async function PendingApprovalPage() {
  ...
  return (
    <div className="min-h-screen bg-vlab-surface-alt flex items-center justify-center px-4">
      <div
        className="bg-white rounded-lg p-10 max-w-md w-full text-center"
        style={{
          boxShadow:
      ...
      >
        ...
        <div className="flex items-center justify-center gap-2 mb-8">
          <span className="text-xl font-bold text-vlab-600">VLab</span>
        </div>
        ...
        {isRejected ? (
          <>
            ...
            <h1 className="text-xl font-bold text-vlab-ink mb-3">
              Account Not Approved
            </h1>
            <p className="text-vlab-muted text-sm leading-relaxed mb-6">
            ...
            <div className="rounded-lg bg-red-50 border border-red-100 px-4 py-3 text-sm text-red-700 text-left mb-6">
          ...
          <>
            ...
            <div className="rounded-lg bg-amber-50 border border-amber-100 px-4 py-3 text-sm text-amber-700 text-left mb-6 flex items-start gap-2">
        ...
        <div className="flex flex-col gap-3">
          <Link
            href="/labs"
            className="w-full py-2.5 rounded-lg border border-vlab-rule-strong text-sm font-medium text-vlab-ink hover:bg-vlab-surface transition-colors"
          >
            Browse Public Labs
          </Link>
          <SignOutButton redirectUrl="/sign-in">
            <button className="w-full py-2.5 rounded-lg text-sm text-vlab-muted hover:text-vlab-ink hover:bg-vlab-surface transition-colors flex items-center justify-center gap-2">
