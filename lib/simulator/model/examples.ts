...
export const STARTER_SMART_TRAFFIC: CircuitDoc = {
  parts: [
    ...
    { id: 'led1_red', type: 'led', x: 40, y: 445, rotation: 0, props: { color: 'red' } },
    { id: 'led1_yellow', type: 'led', x: 88, y: 445, rotation: 0, props: { color: 'yellow' } },
    { id: 'led1_green', type: 'led', x: 136, y: 445, rotation: 0, props: { color: 'green' } },
    { id: 'led2_red', type: 'led', x: 184, y: 445, rotation: 0, props: { color: 'red' } },
    { id: 'led2_yellow', type: 'led', x: 232, y: 445, rotation: 0, props: { color: 'yellow' } },
    { id: 'led2_green', type: 'led', x: 280, y: 445, rotation: 0, props: { color: 'green' } },
    { id: 'led3_red', type: 'led', x: 328, y: 445, rotation: 0, props: { color: 'red' } },
    { id: 'led3_yellow', type: 'led', x: 376, y: 445, rotation: 0, props: { color: 'yellow' } },
    { id: 'led3_green', type: 'led', x: 424, y: 445, rotation: 0, props: { color: 'green' } },
    { id: 'led4_red', type: 'led', x: 472, y: 445, rotation: 0, props: { color: 'red' } },
    { id: 'led4_yellow', type: 'led', x: 520, y: 445, rotation: 0, props: { color: 'yellow' } },
    { id: 'led4_green', type: 'led', x: 568, y: 445, rotation: 0, props: { color: 'green' } },
