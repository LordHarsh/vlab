 ...
 *
 * `title` and `keyComponents` are the lab sheet's too. `description`, `tips`
 * and `buildSteps` are NOT rendered anywhere in this app — nothing reads them
 * — and several still describe the pre-correction wiring; they are left as
